...
<title>我的信息 - PIONEER</title>
<meta name="Keywords" content="java,PIONEERjava" />
    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
            <div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
								<li class="fore-1"><a href="http://localhost:8082/user/info.html">基本信息</a></li>
                                <li class="fore-2"><a class="curr" href="http://localhost:8082/user/userinfo/showImg.html">头像照片</a></li>
                                <li class="fore-3"><a href="http://localhost:8082/user/userinfo/more.html">更多个人信息</a></li>
