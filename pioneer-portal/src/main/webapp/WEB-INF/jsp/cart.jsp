...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">PIONEER价</div>
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount">${fn:length(cartList)}</span> 件商品</div>
        </div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去PIONEER国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去PIONEER结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
