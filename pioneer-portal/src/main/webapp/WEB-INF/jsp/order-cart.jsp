...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/taotao-logo.gif" width="270" height="60" alt="PIONEER商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="陈豫川"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18826136653"/>
		<input type="hidden" name="orderShipping.receiverState" value="广东省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="广州市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="番禺区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="广东工业大学生活西区"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">陈豫川</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">188****6653</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">广东省 广州市 番禺区 </div>
						<div class="adr-m" limit="30">广东工业大学 生活西区 *****</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：PIONEER商城</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">PIONEER快递<i
						class='qmark-icon qmark-tip'
						data-tips='由PIONEER公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由PIONEER配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
